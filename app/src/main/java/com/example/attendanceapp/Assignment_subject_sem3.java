...
public class Assignment_subject_sem3 extends AppCompatActivity implements View.OnClickListener{
    Button sub1, sub2, sub3 ,sub4, sub5;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sem3_assignment);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.sub2:
                ...
                Intent sub2 = new Intent(this, ShowAssignment_sem1_sub1.class);
                startActivity(sub2);
                break;
            case R.id.sub3:
                Toast.makeText(this,"Subject 3",Toast.LENGTH_SHORT).show();
                Intent sub3 = new Intent(this, ShowAssignment_sem1_sub1.class);
                startActivity(sub3);
                break;
            case R.id.sub4:
                Toast.makeText(this,"Subject 4",Toast.LENGTH_SHORT).show();
                Intent sub4 = new Intent(this, ShowAssignment_sem1_sub1.class);
                startActivity(sub4);
                break;
            case R.id.sub5:
                Toast.makeText(this,"Subject 5",Toast.LENGTH_SHORT).show();
                Intent sub5 = new Intent(this, ShowAssignment_sem1_sub1.class);
                startActivity(sub5);
                break;
        }
    }
