...
public class ShowAssignment_sem1_sub5 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent AddAssignment = new Intent(ShowAssignment_sem1_sub5.this, Assignment_sem1_sub1.class);
    ...
    protected void onStart(){
        super.onStart();
        FirebaseRecyclerAdapter<AssignmentHelper, ShowAssignment_sem1_sub5.AssignViewHolder>firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<AssignmentHelper, ShowAssignment_sem1_sub5.AssignViewHolder>
                (AssignmentHelper.class,R.layout.activity_c_showassignment, AssignViewHolder.class,assignment){
            @Override
            protected void populateViewHolder(ShowAssignment_sem1_sub5.AssignViewHolder assignViewHolder, AssignmentHelper model, int i) {
